...
all_majors <- unlist(strsplit(all_majors, "[;]|[,]| or "))
all_majors <- gsub('[[:punct:]]+' , '' , all_majors)
all_majors <- gsub('[[:digit:]]+', '', all_majors)
all_majors <- str_to_title(str_trim(all_majors))
all_majors <- gsub('And', 'and', all_majors)
all_majors <- gsub('Math', 'Mathematics', all_majors)
all_majors <- gsub('Mathematicsematics', 'Mathematics', all_majors)
all_majors <- gsub(' Ms|Ms', '', all_majors)
all_majors <- gsub('Bmi', 'BMI', all_majors)
all_majors <- gsub(' Note Some Were Double Majors', '', all_majors)
all_majors <- gsub('All Participants Are Business Majors', 'Business', all_majors)
